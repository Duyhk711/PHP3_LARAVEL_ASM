        ...
        <div class=" mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <h6 class="text-capitalize text-center">CẬP NHẬT SẢN PHẨM</h6>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="date"
                                                ...
                                                name="ngay_nhap" value="{{ $sanPham->ngay_nhap }}">
                                            @error('ngay_nhap')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div class=" mb-3 ms-1">
                                            <input class=" me-1" type="radio" name="is_type" value="1" {{ $sanPham->is_type == 1 ? 'checked' : '' }}
                                                id="firstRadio" >
                                            <label class="form-check-label text-success" for="firstRadio">Hiển thị</label>

                                            <input class=" me-1" type="radio" name="is_type" value="0" {{ $sanPham->is_type == 0 ? 'checked' : '' }}
                                                id="secondRadio">
                                            ...
                                            <div class="mb-2  col">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input bg-danger" type="checkbox"
                                                        role="switch" id="is_new" name="is_new" {{ $sanPham->is_new == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="is_new">New</label>
                                                </div>
                                                <div class="form-check  form-switch">
                                                    <input class="form-check-input bg-info" type="checkbox"
                                                        role="switch" id="is_hot_deal" name="is_hot_deal" {{ $sanPham->is_hot_deal == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="mb-2  col">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input bg-secondary" type="checkbox"
                                                        role="switch" id="is_hot" name="is_hot" {{ $sanPham->is_hot == 1 ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="is_hot">Hot</label>
                                                </div>
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input bg-success" type="checkbox"
                                                        role="switch" id="is_show_home" name="is_show_home" {{ $sanPham->is_show_home == 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="img_danhmuc" src="{{ Storage::url($sanPham->hinh_anh) }}" style="width: 150px; "
                                                alt="" class="mt-3">
                                        </div>
                                                ...
                                                <tbody id="img-table-body">
                                                    ...
                                                    <tr>
                                                        <td class="d-flex align-items-center">
                                                            ...
                                                            id="preview_{{$index}}"  style="width: 60px;" class="me-2">
