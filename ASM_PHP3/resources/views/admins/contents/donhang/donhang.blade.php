                            ...
                            <tbody class="table-Default">
                                @forelse ($data as $item)
                                    <tr>
                                        ...
                                        <td class=" text-center" style="width: 100px; overflow: hidden;">{{ $item->email_nguoi_nhan }}</td>
                                        
                                        <td class=" text-center" style="width: 100px; overflow: hidden;" >{{ $item->so_dien_thoai }}</td>
                                        <td class=" text-center" style="width: 100px; overflow: hidden;">{{ $item->dia_chi }}</td>
