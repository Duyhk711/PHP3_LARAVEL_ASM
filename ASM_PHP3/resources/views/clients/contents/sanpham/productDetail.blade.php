                             ...
                             <div class="ltn__shop-details-img-gallery">
                                 <div class="ltn__shop-details-large-img">
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/1.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/1.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/2.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/2.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/3.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/3.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/4.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/4.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/5.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/5.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/6.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/6.png" alt="Image">
                                         </a>
                                     </div>
                                     <div class="single-large-img">
                                         <a href="{{asset('assets.clients')}}/img/product/7.png" data-rel="lightcase:myCollection">
                                             <img src="{{asset('assets.clients')}}/img/product/7.png" alt="Image">
                                         </a>
                                     </div>
                                 </div>
